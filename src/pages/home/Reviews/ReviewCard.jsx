...
{
    data?.slice(10,20).map(review=>  <SwiperSlide>
        
        
        <li >
                  <div className=" shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] my-7 w-[300px] lg:w-[350px] h-[400px]">
                  {/*                    <!-- Start Testimonial --> */}
