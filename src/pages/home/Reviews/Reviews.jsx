...
<>
  ...
  <div className="glide-09 relative w-full overflow-hidden">
        ...
        <div data-glide-el="track">
          ...
          {
            data?.slice(44,100).map(review=> <li>
              <div className="w-full shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] my-7 w-[350px] h-[400px]">
              {/*                    <!-- Start Testimonial --> */}
