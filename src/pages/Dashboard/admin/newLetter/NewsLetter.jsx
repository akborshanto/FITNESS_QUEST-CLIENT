...
<UseTitle heading='NEWS LETTER'></UseTitle>

   
      <section class="container px-4 mx-auto">
      <div class="flex items-center gap-x-3">
          <h2 class="text-lg font-medium text-gray-800 dark:text-white">   NEWS LETTER
          </h2>
  
          <span class="px-3 py-1  text-blue-600 bg-blue-100 rounded-full dark:text-blue-400 text-2xl lg:text-4xl">{data?.length} users</span>
      </div>
...
data?.map(subsc=> <tr>
                                  <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                      <div class="inline-flex items-center gap-x-3">
                                          ...
                                          <div class="flex items-center gap-x-2">
                                              <div>
                                                  <h2 class="font-medium text-gray-800 dark:text-white ">{subsc?.name}</h2>
                                  ...
                                  <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{subsc?.email}</td>
